...
import com.ifsp.todolistarq.databinding.ViewTarefaBinding
...
class TarefasAdapter(
    ...
    class TarefaViewHolder(val viewTarefaBinding: ViewTarefaBinding) :
        RecyclerView.ViewHolder(viewTarefaBinding.root), View.OnCreateContextMenuListener {
